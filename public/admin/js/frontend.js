    ...
    $(document).ready(function () {
        ...
        $("#car_info_section").on("submit", function (e) {
            ...
            let fields = [
                ...
                {
                    id: "#flexibility_description",
                    condition: (val) => val.trim() === "",
                },
                { id: "#maintained", condition: (val) => val.trim() === "" },
                {
                    id: "#maintained_description",
                    condition: (val) => val.trim() === "",
                },
        ...
        $("#brand_section").on("submit", function (e) {
            ...
            $(".vacation-description, .car, .vacation, .vacation-url").each(
                function () {
                    const $this = $(this);
