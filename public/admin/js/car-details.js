$(function () {
    ...
    $(document).ready(function () {
            ...
            let fields = [
                {
                    id: "#hub_city",
                    wrapper: true,
                    condition: (val) => val === null || val === "Hub",
                },
                {
                    id: "#car_model",
                    wrapper: true,
                    condition: (val) => val === null || val === "Model",
                },
                {
                    id: "#register_number",
                    wrapper: false,
        ...
        function updateTable(data, permissions) {
            ...
            if (data.length === 0) {
                ...
                <tr>
                    ...
                    <a href="javascript:void(0)" class="edit_model" data-id="${
                        item.car_model ? item.car_model.id : 0
                    }"
                           data-producer="${
                               item.car_model ? item.car_model.producer : ""
                           }"
                           data-model_name="${
                               item.car_model ? item.car_model.model_name : ""
                           }"
                           data-seat="${
                               item.car_model ? item.car_model.seat : ""
                           }"
                           data-fuel_type="${
                               item.car_model ? item.car_model.fuel_type : ""
                           }"
                           data-transmission="${
                               item.car_model ? item.car_model.transmission : ""
                           }"
                           data-engine_power="${
                               item.car_model ? item.car_model.engine_power : ""
                           }"
                           data-price_per_hour="${
                               item.car_model
                                   ? item.car_model.price_per_hour
                                   : ""
                           }"
                           data-dep_amount="${
                               item.car_model ? item.car_model.days : ""
                           }"
                           data-extra_hours_charge="${
                               item.car_model
                                   ? item.car_model.extra_hours_price
                                   : ""
                           }"
                           data-day_km="${
                               item.car_model ? item.car_model.per_day_km : ""
                           }"
                           data-weekend_surge="${
                               item.car_model
                                   ? item.car_model.weekend_surge
                                   : ""
                           }"
                           data-peak_reason_surge="${
                               item.car_model
                                   ? item.car_model.peak_reason_surge
                                   : ""
                           }"
                           data-extra_km_charge="${
                               item.car_model
                                   ? item.car_model.extra_km_charge
                                   : ""
                           }">
                    ...
                    ${
                        permissions.includes("car_listing_update_model")
                            ? `
        ...
        $("#car_table").on("click", ".edit_model", function () {
            ...
            $("#singleImageContainer").html(
                `<img src="/storage/car_image/${singleImage}" alt="Single Car Image" class="img-fluid">`
            );
            ...
            modal
                .find("#extra_hours_charge")
                .val($(this).data("extra_hours_charge"));
