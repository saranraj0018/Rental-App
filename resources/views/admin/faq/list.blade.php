    ...
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                @if (in_array('faq_create', getAdminPermissions()))
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="search_item" name="question" class="form-control"
                    ...
                    <table id="faq_table" class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                @if (in_array('faq_update', getAdminPermissions()) || in_array('faq_delete', getAdminPermissions()))
                                    <th>Action </th>
                                @endif
                                ...
                                @foreach ($faq_items as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if (in_array('faq_update', getAdminPermissions()))
                                                <a href="javascript:void(0)" class="faq_edit" data-id="{{ $item->id }}"
                                            ...
                                            @if (in_array('faq_delete', getAdminPermissions()))
                                                <a href="#" class="faq_delete text-danger w-4 h-4 mr-1"
                                                    data-id="{{ $item->id }}">
                                                    <svg class="filament-link-icon w-4 h-4 mr-1"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                        fill="currentColor" aria-hidden="true">
