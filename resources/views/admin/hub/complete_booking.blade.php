            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="complete_car_model" name="car_model" class="form-control" placeholder="Search Car Model">
                        </div>
                        <!-- Search for Registration Number -->
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="complete_register_number" name="register_number" class="form-control" placeholder="Search Registration Number">
                        </div>
                        <!-- Search for Booking ID -->
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="complete_booking_id" name="booking_id" class="form-control" placeholder="Search Booking ID">
                        </div>
                        <!-- Search for Customer Name -->
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="complete_customer_name" name="customer_name" class="form-control" placeholder="Search Customer Name">
                        </div>
                    </div>
                </div>
