...
<body style="background: #f4f4f4; font-family: sans, arial; padding: 1em 12em">
  ...
  <div>
    ...
    <p style="font-style: italic; color: #555">Your booking <span style="color: #000">{{ $booking->booking_id }}</span> with Valam Cars has been canceled.</p>
    <p style="font-size: .8em">We’re truly sorry to miss the opportunity to provide you with a great experience, and we hope to serve you again in the future. The refundable amount will be processed back to your original payment method within 7 working days. Let us know how we can improve our services.</p>
