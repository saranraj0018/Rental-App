                ...
                <div class="card-body table-responsive p-0">
                    <table id="cancel_booking_table" class="table table-hover text-nowrap">
                        ...
                        <tr>
                            ...
                            <th>Time</th>
                            <th>
                                <input type="text" id="cancel_customer_name" name="cancel_customer_name" class="form-control" placeholder="Name">
                            </th>
                            <th> <input type="text" id="cancel_car_model" name="cancel_car_model" class="form-control" placeholder="Model" style="padding: 0%;"></th>
                            <th><input type="text" id="cancel_register_number" name="cancel_register_number" class="form-control" placeholder="Registration Number"></th>
                            <th>Address</th>
                            <th>User Details</th>
                            <th>D/L Number</th>
                            <th><input type="text" id="cancel_booking_id" name="cancel_booking_id" class="form-control" style="padding: 0%    ;" placeholder="Booking ID"></th>
                            <th>Reschedule</th>
                            <th>Security Dep</th>
                            <th>Amount</th>
                        </tr>
