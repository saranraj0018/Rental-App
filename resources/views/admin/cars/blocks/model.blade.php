<div class="modal fade" id="create_block" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel"
    aria-hidden="true">
                ...
                <form id="car_block_form">
                    ...
                    <div class="form-row">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="block_type" id="maintenance"
                                value="0" checked>
                            <label class="form-check-label" for="maintenance">Maintenance</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input discretionary" type="radio" name="block_type"
                                id="discretionary" data-discretionary="discretionary" value="1">
                            <label class="form-check-label" for="discretionary">Discretionary</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="block_type" id="availability_type"
                                value="2">
                            <label class="form-check-label" for="availability_type">Availability Type</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="block_type" id="refurbish"
                                value="3">
                            <label class="form-check-label" for="refurbish">U-Refurbish</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="block_type" id="recovery"
                                value="4">
                            <label class="form-check-label" for="recovery">U-Recovery</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="block_type" id="reserve"
                                value="5">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group date datetimepicker" id="datetimepicker"
                                ...
                                <input type="text" class="form-control datetimepicker-input"
                                    data-target="#datetimepicker" id="start_date" name="start_date"
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group date" id="enddatetimepicker" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input"
                                    data-target="#enddatetimepicker" id="end_date" name="end_date"
                                    placeholder="Select end date and time" />
                                <div class="input-group-append" data-target="#enddatetimepicker"
                                    data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                                <div class="invalid-feedback">
                    ...
                    <div class="form-row gx-3">
                        <div class="form-group col-md-3 mt-3">
                            <select id="hub_city" name="hub_city" class="form-select w-100"
                        ...
                        <div class="form-group col-md-3 mt-3">
                            <select id="car_model" name="car_model" class="form-select w-100"
                                data-live-search="true">
                        ...
                        <div class="form-group col-md-3 mt-3 ">
                            <input type="text" class="form-control w-100 " id="booking_id" name="booking_id"
                        ...
                        <div class="form-group col-md-3 mt-3">
                            <select id="block_car_register_number" name="block_car_register_number"
                                class="form-select w-100" data-live-search="true">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reason" id="major_repair"
                                        value="0">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reason" id="accident"
                                        value="1">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reason" id="service"
                                        value="3">
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reason" id="others"
                                        value="4">
                    ...
                    <div id="reason_discretionary">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="reason_discretion"
                                        id="buffer" value="5">
