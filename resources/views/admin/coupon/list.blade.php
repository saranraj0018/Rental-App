        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    @if (in_array('coupon_history', getAdminPermissions()))
                        <a href="{{ route('coupon.history') }}" class="btn btn-primary mb-3">Coupon History</a>
                    @endif
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group" style="width: 250px;">
                            <input type="text" id="coupon_search" name="keyword" class="form-control" placeholder="Search Coupon....">
                        </div>
                    </div>
                </div>
                            ...
                            @foreach($coupons as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" class="coupon_edit" data-id="{{ $item->id }}"  data-title="{{ $item->title }}" data-description="{{ $item->description }}"
                                           data-start_date="{{ $item->start_date }}" data-end_date="{{ $item->end_date }}" data-amount="{{ $item->amount }}" data-type="{{ $item->type }}"
                                           data-prefix="{{ $item->prefix }}" data-code="{{ $item->code }}"  data-status="{{ $item->status }}">
