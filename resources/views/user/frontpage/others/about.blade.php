...
<section>
        ...
        <div class="container-fluid p-3">
                                ...
                                <ul class="navbar-nav navbar-light w-100 ms-0 ms-lg-5 ps-0 ps-lg-5 text-end text-lg-start">
                                    ...
                                    <li class="nav-item ms-0 ms-lg-3 ps-0 ps-lg-0">
                                        ...
                                        <div class="d-flex justify-content-center justify-content-md-end mt-1 mb-2">
                                            <div class="me-3"><p class="text-blue m-0 border-blue w-fit rounded-3 f-16 py-1 px-2">{{ \Illuminate\Support\Facades\Auth::user()->name ?? ''  }}</p></div>
            ...
            <div class="container mb-3 py-5">
                ...
                <p class="fs-16 text-white text-center">
                    Welcome to Valam Cars, India's premier self-driving car rental service! At Valam, we believe in empowering people to take charge of their journeys, offering a hassle-free and reliable self-driving experience. Whether you need a car for a quick city trip, a long weekend getaway, or a business journey, we provide an easy and flexible solution for all your travel needs.
                </p>
    ...
    <section class="my-5">
        <div class="container">
            ...
            <p class="fs-16 text-center">
                Valam Cars was founded with the vision to make car rentals <br>accessible, affordable, and seamless for everyone.
            </p>
    ...
    <section class="my-5 py-5 blue-light-bg">
        <div class="container">
            ...
            <p class="fs-16 text-center">
                Your trusted partner for affordable, convenient, and secure self-drive rentals.<br> Enjoy a seamless experience with our diverse fleet and 24/7 support.
            </p>
            <div class="row g-3">
                <div class="col-12 col-lg-6">
                        ...
                        <div>
                            <div>
                                ...
                                <p class="fs-16 text-justify">
                                    Our pricing is transparent and competitive, ensuring that you get the best deal without hidden charges.
                                </p>
                            </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="bg-primary bdr-20 text-white h-100 p-3">
                        <div>
                            <div>
                                <p class="fs-16 text-justify">
                                    All our cars come equipped with GPS tracking, and our rentals include basic insurance coverage, ensuring your safety on the road.
                                </p>
                            </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="bg-primary bdr-20 text-white h-100 p-3">
                        <div class="w-50 mt-3">
                            <img src="{{ asset('user/img/about/Vector (1).png') }}" alt="" class="img-fluid w-25">
                        </div>
                        <p class="fs-16 text-justify mt-4">
                            Our dedicated support team is available round-the-clock to assist you with any queries or issues during your journey.
                        </p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-7">
                    <img src="{{ asset('user/img/about/from Right Front View 1.png') }}" alt="" class="img-fluid">
                </div>
                <div class="col-12 col-lg-5 my-auto">
                    <div class="bdr-20 border border-white p-2">
                        <ul class="text-white m-0">
                            <li>Hourly, Daily, and Weekly Rentals: We offer flexible rental plans so you can choose the duration that fits your needs.</li>
                            <li>Interstate Travel: Whether you’re planning a road trip or an outstation journey, Valam Cars is with you, offering interstate travel options.</li>
                            <li>Easy Pickup & Drop Locations: We have pickup and drop-off points across multiple cities for your convenience.</li>
                        </ul>
                    </div>
                </div>
            </div>
