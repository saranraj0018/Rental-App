                        ...
                        <ul class="navbar-nav navbar-light w-100 text-end text-lg-start">
                            <li class="nav-item ps-0 ps-lg-0 my-auto">
                                ...
                                <div id="after_login_button" class="mt-1 mb-2 nav-link d-flex " style="display: {{ Auth::check() ? 'block' : 'none !important' }};">
                                    ...
                                    <div class="ms-2">
                                        <p class="text-white p-2 rounded-pill bg-primary m-0 my-1 w-fit rounded-3 f-16 px-2 fs-13 fw-600" id="user_name">{{ !empty(Auth::user()->name) ? ucfirst(Auth::user()->name) : ''  }}</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="row gy-3 gy-lg-0">
            <div class="col-12 col-lg-6">
                <div class="card p-3 bdr-30 h-100">
                    <div class="d-flex justify-content-between"  style="display: @if (!empty($general_section['show_bookmarks']) && $general_section['show_bookmarks'] == 1) flex @else none @endif !important">
                        <div>
                        ...
                        <div class="owl-carousel owl-carousel-6 owl-theme">
                            @if(!empty($image_list))
                                @foreach($image_list as $image)
                                    <div class="item">
                                        <img src="{{ asset('storage/car_other_image/'.$image->name) }}" alt="car-logo"  class="img-fluid cb-car-img"  style="object-fit: cover">
                                    </div>
                                @endforeach
                            @endif
                        </div>
                ...
                <div class="p-3">
                    <div id="delivery-section" class="slide-section">
                        ...
                        <div class="d-block d-lg-flex">
                            <button type="button" class="btn fs-16 my-button mt-4 w-100 w-lg-25" id="delivery_address">Confirm Location</button>
                            <button type="button" class="btn fs-16 my-drop-button mt-4 mx-2 w-100 w-lg-25" id="same_address">Same as Pickup Location</button>
                            <button type="button" class="btn fs-16 my-current-button rounded-pill mt-4 w-100 w-lg-25" id="drop_current_location">Current Location</button>
                        </div>
                    </div>
