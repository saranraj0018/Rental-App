                        ...
                        <div class="d-flex justify-content-between">
                           <div>
                                <div class="bg-white rounded-pill w-fit px-1 fw-500 fs-15 my-auto"
                                     style="display: @if (!empty($general_section['show_bookmarks']) && $general_section['show_bookmarks'] == 1) unset @else none @endif !important">
                                    <i class="fas fa-star" style="color:#E66742;"></i> 4.5
                                </div>
                            </div>
                            <div   style="display: @if (!empty($general_section['show_bookmarks']) && $general_section['show_bookmarks'] == 1) unset @else none @endif !important">
