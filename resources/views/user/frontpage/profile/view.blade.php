            ...
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div class="d-flex text-white">
                        <div>
                            <a href="{{ route('home') }}" class="border-2 rounded-pill px-3 py-2 me-3 back-btn"
                                role="button"><i class="fa fa-angle-left text-white fs-18"></i></a>
                        </div>
        ...
        <section class="my-5">
            <div class="container profile-bg py-3 px-2 bdr-20">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-2 my-auto mt-5 d-flex justify-content-center align-items-center">
                        {{-- <div class="d-flex justify-content-center"> --}}
                        <button type="submit" class="btn blue-bg text-white rounded-pill w-100 fs-14 fw-500"
