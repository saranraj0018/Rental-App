            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 my-1 mt-2 my-lg-0">
                    ...
                    <div class="input-group my-grps">
                        ...
                        <input type="text" class="form-control my-hub" id="dateTimeInput1"
                            placeholder="Select first date and time" data-bs-toggle="modal"
                            data-bs-target="#dateTimeModal1" value="{{ session('start_date') }}" readonly>
                    </div>
                </div>
                <div class="col-12 col-lg-3 mt-2 mb-2 my-lg-0">
                    ...
                    <div class="input-group my-grps">
                        ...
                        <input type="text" class="form-control my-hub" id="dateTimeInput2"
                            placeholder="Select second date and time" data-bs-toggle="modal"
                            data-bs-target="#dateTimeModal2" value="{{ session('end_date') }}" readonly>
                    </div>
                </div>
