            ...
            <div class="container">
                <div class="ac-car-active bdr-20 mb-3">
                    ...
                    <div class="row gx-3 p-3">
                            ...
                            <div class="ms-4">
                                ...
                                <p class="d-flex text-secondary fs-12">
                                    ...
                                    <img src="{{ asset('user/img/search-result/material-symbols-light_air.png') }}" alt="icon"
                                        class="img-fluid mx-1 conf-icon my-auto ms-4">AC
                        ...
                        <div class="col-3 my-auto" style="text-align: right">
                            <div class="my-2">
                                @php
                                ...
                                @endphp
                                <div class="fs-4 fw-600 text-right pr-1"> ₹{{ $price_list['total_price'] ?? '' }}</div>
                            </div>
                            @if ($model['booking_status'] === 'available')
                                <a href="{{ route('book.car', ['model_id' => $model->id]) }}" class="btn my-button py-2 px-3"
                                    style="width: fit-content">Book
                                    now</a>
...
<section class="d-flex d-md-none container"
    style="place-items: center; flex-direction: column; gap: 1.5em; align-items: center">
    @if (!empty($car_models))
        @foreach ($car_models as $key => $model)

            <div class="card mb-2 p-0 w-100">
                <div class="card-body p-0"
                    style="display: flex; flex-direction: column; justify-content: space-between; align-items: start; border-radius: inherit;">
                    <img style="width: 100%; height: 40vh; object-fit: cover;"
                        src="{{ asset('storage/car_image/' . $model->carModel->car_image ?? '') }}"
                        alt="cars" class="img-fluid w-100 car-list-image-for-grid">
                    ...
                    <div class="w-100 p-3">
                        <div class="my-2 d-flex gap-2">
                            ...
                            @endphp
                            <div class="fs-4 fw-600 text-center"> ₹{{ $price_list['total_price'] ?? '' }}</div>
                            @if ($model['booking_status'] === 'available')
                                <a href="{{ route('book.car', ['model_id' => $model->id]) }}"
                                    class="btn my-button py-2 px-3 w-100">Book
                                    now</a>
                            @elseif ($model['booking_status'] === 'sold')
                                <button type="button" class="sold-button btn btn-lg fs-14">Sold</button>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-8 my-auto p-3">
                    ...
                    {{-- <button class="btn bg-white rounded-pill fw-600 text-blue my-4 p-1 px-3">Book your car
                        now</button> --}}
                </div>
                <div class="col-4">
                </div>
