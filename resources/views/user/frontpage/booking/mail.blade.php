...
<body style="background: #f4f4f4; font-family: sans, arial; padding: 1em 12em">
  ...
  <div>
    ...
    <p style="font-style: italic; color: #555; font-size: .9em">Thanks for booking with Valam cars! <strong style="color: #000;font-size: .8em">This email confirms your booking details</strong> and lists some important points that we request you to read beforehand.</p>

    <div style="padding: .3em; background: lightgray; border-radius: 5px">
      <span style="font-style: italic; color: #111; font-size: .8em; padding: 0 1em">For further questions or help, please visit <a href="https://www.valamcars.com">www.valamcars.com</a> or call us at <a href="#">+91-9363065901.</a></span>
      ...
      <ul style="font-size: .7em">
        ...
        <li>Booking duration: <b>{{ \Carbon\Carbon::parse($booking->start_date)->diff(\Carbon\Carbon::parse($booking->end_date))->format('%d day(s), %h hour(s), %i minute(s)') }}</b></li>
    ...
    <div style="padding: .3em; background: lightgray; border-radius: 5px; margin-top: 1em">
      <span style="font-style: italic; color: #111; font-size: .8em; padding: 0 1em">Important Points to Keep in Mind:</span>

      <div style="margin: 0 1.3em">
        <h6 style="font-weight: 900; margin-bottom: 0">1. ID Verification</h6>
        <ul style="font-size: .7em">
          <li>Please have your original Driving License and original ID proof (the same documents you provided during booking) <br /> ready for verification at the time of delivery.</li>
          <li>Our executive will verify these documents, and this step is mandatory.</li>
          <li>Note: If you cannot provide these documents, we will be unable to hand over the car,<br /> and it will be treated as a late cancellation (100% of the fare will be charged).</li>
          <li>Important: Driving licenses printed on A4 sheets (original or otherwise) will not be accepted.</li>
        </ul>
      </div>
      ...
      <div style="margin: 0 1.3em">
        ...
        <ul style="font-size: .7em">
          <li>Cars equipped with Fastag will automatically deduct tolls on National Highways, which will be added to your invoice.</li>
          <li>All other tolls, parking fees, MCD, and inter-state taxes are your responsibility and must be paid separately.</li>
        </ul>
      </div>
      ...
      <div style="margin: 0 1.3em">
        ...
        <ul style="font-size: .7em">
          <li>Before starting your trip, inspect your Valam car and its fuel gauge, and approve the checklist provided by our executive.</li>
        </ul>
      </div>
      ...
      <div style="margin: 0 1.3em">
        ...
        <ul style="font-size: .7em">
          <li>If you need to extend your trip, inform us at least 3 hours in advance. Extensions are subject to availability.</li>
    ...
    <div style="padding: .3em; background: lightgray; border-radius: 5px">
      <span style="font-style: italic; color: #111; font-size: .8em; padding: 0 1em; ">Valam Terms and Conditions:</span>
      <p style="padding: 0 1em; margin: 1em 0 0 0; font-size: .7em; font-weight: 500">We recommend familiarizing yourself with Valam’s terms and conditions. You can find them:</p>
      <ul style="font-size: .7em">
    ...
    <p style="font-size: .8em; margin-top: 2em">For further assistance or questions, please visit our website at <a href="https://www.valamcars.com">www.valamcars.com</a> or call us at <a href="#">+91-9363065901.</a>. <br />Thank you for choosing Valam Cars! Enjoy your ride!</p>
