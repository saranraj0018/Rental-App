        ...
        <div class="home-demo sec-2">
            <div class="owl-carousel owl-carousel-1 owl-theme">
                @foreach ($section2 as $item)
                    @if ($item->status == 1)
                        <div class="item p-2 pb-2 pb-lg-3 coupon_info" data-title="{{ $item->title }}"
                            data-description="{{ $item->description }}"
                            data-amount="{{ number_format($item->amount, 0) }}"
                            data-type="{{ $item->type == 1 ? '%' : '₹' }}" data-prefix="{{ $item->prefix }}"
                            data-code="{{ $item->code }}">
                            <div class="ms-2">
                                ...
                                <div class="card blue-bg p-2 text-white d-flex">
                                    <div class="d-flex">
                                        ...
                                        <span class="fs-16 fs-mb-12 fw-500">
                                            {{ $item->amount }}{{ $item->type == 1 ? '%' : '₹' }}</span>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content bdr-20">
                <div class="modal-body">
                    <button type="button" class="btn-close float-end close-button text-white" data-bs-dismiss="modal"
                    ...
                    <div class="row p-4">
                        <div class="col-10">
                            ...
                            <div class="d-flex my-3">
                                <img src="{{ asset('user/img/bxs_offer.svg') }}" alt="Bagde Percentage"
                                    class="img-fluid me-1 me-lg-2 badge-perc-2 my-auto">
                            ...
                            <div class="d-flex">
                                ...
                                <button class="btn bdr-10 ms-3 copy-btn fs-14" id="copyButton"><i
                                        class="fas fa-clone"></i> Copy Code</button>
                            </div>
