...
class UserController extends Controller {
    public function view() {
        ...
        $_settings = json_decode(Frontend::where('data_keys', 'general-setting')->orderBy('created_at', 'desc')->first()->toArray()['data_values']);
        $_setting = (array) $_settings;


        return view('user.frontpage.list-home', compact('section1', 'section2', 'section3', 'section4', 'car_image'
            , 'brand_image', 'section8', 'faq_items', 'general_setting', 'timing_setting', 'city_list', '_setting'));
    }
    ...
    public function listCars() {
        ...
        return view('user.frontpage.list-cars.list', compact('car_models', 'festival_days', 'date', 'city_list', '_setting'));
    }
    ...
    public function bookingCar($id) {
        ...
        return view('user.frontpage.single-car.view', compact('car_model', 'ipr_data', 'image_list', 'price_list', 'general_section', 'available_cars', '_setting'));
    }
